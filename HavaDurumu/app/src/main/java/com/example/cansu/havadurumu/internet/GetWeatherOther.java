...
public class GetWeatherOther extends AsyncTask<String , Void , WeatherInfo> {
    private final String LOG_TAG = GetWeatherOther.class.getSimpleName();

    private Uri builtDay;
    private Prefs preferences;

    public GetWeatherOther(Context context) {
