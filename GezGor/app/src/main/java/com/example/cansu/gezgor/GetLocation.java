...
public class GetLocation implements LocationListener {
    ...
    private final static long MIN_DISTANCE_FOR_UPDATE = 10;//Minimum distance change for update in meters, i.e. 10 meters.
    ...
    public GetLocation(Context context){
        ...
        if(!isGPSEnabled && !isNetworkEnabled){// no network provider is enabled
            ...
            canGetLocation = true;// First get location from Network Provider
            if(isGPSEnabled){
